...
function Privacidade() {
    return (
        <React.Fragment>
            ...
            <Container>
                <Box sx={{ mt: 7, mb: 12 }}>
                <Typography variant="h5">   A coleta de alguns Dados Pessoais dos USUÁRIOS é requisito necessário à utilização da Plataforma, de modo que, o USUÁRIO que deseje que os seus Dados Pessoais não sejam coletados, não deverá dar prosseguimento à navegação ou a utilização da Plataforma.
...
De modo a evitar situações de vulnerabilidade e ameaças digitais, ao site TALITA ARAUJO PSICOLOGIA recomenda ao USUÁRIO não usar computadores públicos, bem como apagar os históricos de conversações sempre após as sessões realizadas por meio da Plataforma. Além disso, o site TALITA ARAUJO PSICOLOGIA alerta o USUÁRIO quanto à importância de proteger o seu computador com um programa de antivírus e firewall.</Typography>
                </Box>
            </Container>
            <AppFooter />
        </React.Fragment>
